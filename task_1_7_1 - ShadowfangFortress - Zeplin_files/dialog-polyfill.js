(function() {
  ...
  document.addEventListener('submit', function(ev) {
    var target = ev.target,
        paperRipples = ev.target.querySelectorAll("paper-ripple"),
        currentDialog = ev.target.parentElement.parentElement;
    ...
    [].forEach.call(paperRipples, function (paperRipple) {
      paperRipple.addEventListener("transitionend", function rippleEnd() {
        paperRipple.removeEventListener("transitionend", rippleEnd);
        ...
        dialog.hasAttribute('open') && dialog.close(returnValue);
